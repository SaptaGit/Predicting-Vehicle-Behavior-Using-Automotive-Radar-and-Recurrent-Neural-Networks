...
hold on
plot(t9,OGMTechnique, '-^', 'LineWidth',2, 'MarkerSize',12)
hold on
...
lgd = legend('CV', 'V-LSTM', 'Dual-LSTM ', 'CS-LSTM', 'MATF','SCALE-Net', 'OGM technique', 'Proposed (GT-surrounding)', 'Proposed (retrain technique)');
lgd.FontSize = 13;
