...
# validationVehicleList = [5,6,9,10,22,28,38,39,47,49,66,71,105,106,107,171,172]   # new list for train
...
def __main__():
    ...
    if(trainOrTest == trainStr):
        ...
        # Save the model
        encoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/AlvieEncoderV2.h5')
        decoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/AlvieDecoderV2.h5')


    elif(trainOrTest == testStr):
        print('Starting testing !!!')

        encoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/AlvieEncoderV2.h5')
        decoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/AlvieDecoderV2.h5')
