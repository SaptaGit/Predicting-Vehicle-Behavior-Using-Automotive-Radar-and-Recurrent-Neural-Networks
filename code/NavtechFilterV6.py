        ...
        if (self.annotations != None):
            for anotationIndex, object in enumerate(self.annotations):
                            ...
                            for eachSurroundingBoxList,eachSurroundingVisibleList,eachSurroundingDeleteList,eachSurroundingId in zip(allSurroundingBoundingBoxes,allSurroundingVisibleParam,allSurroundingDeleteParam,allSurroundingIds):
                                ...
                                if (sameFrameBBox):
                                    ...
                                    if (sameFrameDelete == 0):
                                        ...
                                        surroundingCentrePosesDict[str(sameFrameID)].append([surroundingCx,surroundingCy])
                                        ...
                                        surroundingCentrePosesDict[str(sameFrameID)].append([-1,-1])
                                else:
                                    # If the car doesn't exist in the current frame append -1 for future use
                                    surroundingCentrePosesDict[str(sameFrameID)].append([-1,-1])
                ...
                for trajIndex in range(3,TargetVehiclePoseLength):
                    ...
                    # If there are zero surrouding car ignore the whole surroudning process and just do the padding
                    if(currentSurroundingCarCount != 0):
                        ...
                        for eachRelevenetIndex in releventSurroundingIndexes:
...
def __main__():
    ...
    if(trainOrTest == trainStr):
        ...
        # Save the model
        encoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV2.h5')
        decoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV2.h5')
        ...
        model, encoder_model, decoder_model = CreateModel()
        encoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV2.h5')
        decoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV2.h5')
