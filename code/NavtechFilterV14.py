...
# Diffent Maneuver and velocity fix and batchNorm and removed angle and multiple prediction for distribution and removed redundent lanes, confusion matrix augmentation
# No Angle, no maneuver, and the whole traj same class
# without dropout smooth, adding two dropout for each setion and check for smooth traj -> smooth
# adding dropout and batch check for jerk
# 64 jerky check with 32....... 13.7 with one batchnorm, trying with 3 now
...
class EarlyStoppingByLossVal(callbacks.Callback):
    def __init__(self, monitor='val_loss', value=1.0, verbose=0):
        ...
        for idx in range(historyTemporal,currentVehicleLength-futureTemporal):
            ...
            for repeat in range(0,repeatCount):
                ...
                for drawIndex in range(1,predPoseLength):
                    ...
                    if(currentDrawMan == leftTurnStr or currentDrawMan == rightTurnStr):
                        predColor = (0,0,255)
...
def __main__():
    ...
    if(trainOrTest == trainStr):
        ...
        # Save the model
        encoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV14.h5')
        decoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV14.h5')


    elif(trainOrTest == testStr):
        print('Starting testing !!!')

        encoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV14.h5')
        decoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV14.h5')
