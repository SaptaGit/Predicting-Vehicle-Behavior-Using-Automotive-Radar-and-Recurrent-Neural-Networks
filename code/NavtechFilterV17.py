...
trainOrTest = trainStr   #   do not change ....collect data first....  \ 17, 22 error.....
...
leakyAlphaValue = 0.8   #0.8
dropOutFrac = 0.25
batchSize = 16  #16    # 16  32 #64
nepochs = 50
surroudingCarCounts = 3   # originally 3
extraSurroudingCarCount = 6  # This is to show other cars as well
...
# validationVehicleList = [47,58,157,57,94,115,155,137,120,36,11,25,52,6,25,38,50,13,101,105,68,112]     # 159 new 66
validationVehicleList = [66,159]
...
def TestModel(encoder_model,decoder_model):
    ...
    for eachTrainCar in carInfoList:
        ...
        for idx in range(historyTemporal,currentVehicleLength-futureTemporal,3):
...
def __main__():
    ...
    if(trainOrTest == trainStr):
        ...
        # Save the model
        encoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV17.h5')
        decoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV17.h5')


    elif(trainOrTest == testStr):
        print('Starting testing !!!')

        encoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV17.h5')
        decoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV17.h5')
