# leaky 0.1, 5 surrouding, early 1.2, batch 1024(due to memory...) lrate 0.002 step 2.0 epoch 150 BatchNorm Layers-> 9.1 (val_loss 0.89)... repeat..10.6...
# leaky 0.1, 4 surrouding, early 0.5, batch 1024(due to memory...) lrate 0.002 step 2.0 epoch 150 BatchNorm Layers-> 23.9... repeat..31.7...
# leaky 0.1, 4 surrouding, early 0.5, batch 1024(due to memory...) lrate 0.002 step 2.0 epoch 150 only pos BatchNorm Layers-> 30.7...repeat..28.0...
# leaky 0.1, 5 surrouding, early 0.2, batch 1024(due to memory...) lrate 0.002 step 2.0 epoch 150 only pos BatchNorm Layers-> 55.2....repepat..running...

# if not good try adding batchnorm layers.......
...
folderName ='/media/disk1/sap/Junction/Transfer5Surrounding'                 #Surrounding4RelativeDecoderJuncDist Transfer5Surrounding  smallTest Transfer5SurroundingQuick
...
# Path for Sen server folder
encoderModelFilename = '/media/disk1/sap/Junction/TransferV2Encoder9.h5'
decoderModelFilename = '/media/disk1/sap/Junction/TransferV2Decoder9.h5'
# Path for Big Screen Server folder
...
resultFileName = 'TransferV2Run13.txt'
