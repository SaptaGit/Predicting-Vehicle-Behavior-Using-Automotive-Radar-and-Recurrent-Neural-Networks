...
# validationVehicleList = [58,157,57,20,36,11,25,52,6,25,38,50,13,101,105,68,112,47,94,115,137,155]     # 159  66 new ***********
# validationVehicleList = [2,6,9] 
# validationVehicleList = [107]
validationVehicleList = [58,20,36,11,25,52,6,25,38,50,13,68,112,5,6,8,9,10,11,32,33,37,39,60,61,62,68,86,92,109,111,121,122,123,126]
    ...
    for eachTrainCar in carInfoList:
        ...
        for idx in range(historyTemporal,currentVehicleLength-futureTemporal):
            ...
            for jdx in range(idx-historyTemporal,idx):
                ...
                resultMapImage = cv2.putText(resultMapImage, 'Red : Near Surroundings', (750,140), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2, cv2.LINE_AA)
                ...
                resultMapImage = cv2.putText(resultMapImage, 'Violet : Target Car', (750,200), cv2.FONT_HERSHEY_SIMPLEX, 1, (238,130,238), 2, cv2.LINE_AA)
                ...
                resultRadarImage = cv2.putText(resultRadarImage, 'Red : Near Surroundings', (750,140), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2, cv2.LINE_AA)
                ...
                resultRadarImage = cv2.putText(resultRadarImage, 'Violet : Target Car', (750,200), cv2.FONT_HERSHEY_SIMPLEX, 1, (238,130,238), 2, cv2.LINE_AA)
...
def __main__():
    ...
    if(trainOrTest == trainStr):
        ...
        # Save the model
        encoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV18.h5')
        decoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV18.h5')


    elif(trainOrTest == testStr):
        print('Starting testing !!!')

        encoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV18.h5')
        decoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV18.h5')
