...
# old data, New arch, early 0.15, batch 256, only 2 BatchNorms for each section and common batchnorm, epochs_drop = 6.0 with extra zero for lower cap, RMSProp -- running
...
folderName = '/home/sap/Sap/Junction/Surrounding4RelativeDecoderJuncDist'
...
resultFileName = 'V25ModidiedDecoder2.txt'
