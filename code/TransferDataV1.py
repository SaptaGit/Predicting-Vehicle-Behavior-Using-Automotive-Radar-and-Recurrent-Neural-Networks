...
# bBug screen data 3rd terminal  another with 3 surrouding....
import os
...
# folderName ='/media/disk1/sap/Junction/Transfer4SurroundingQuick'                 #Surrounding4RelativeDecoderJuncDist Transfer5Surrounding  smallTest
# Path for Big Screen Server folder
folderName = '/home/sap/Sap/Junction/Transfer3SurroundingQuick'
...
# Path for Sen server folder
encoderModelFilename = '/media/disk1/sap/Junction/TransferV1Encoder1.h5'
decoderModelFilename = '/media/disk1/sap/Junction/TransferV1Decoder1.h5'
# Path for Big Screen Server folder
...
resultFileName = 'TransferV1Run47.txt'
...
# Validation vehiles
totalVehileCount = 1500    #1600 # 2200
