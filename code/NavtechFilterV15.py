...
trainStr = 'Train'
testStr = 'Test'
#   do not change ....collect data first....
...
# validationVehicleList = [47,58,157,57,94,115,66,155,137,120,36,11,25,52,6,25,38,50,13,101,105,68,112,159]     # 159 new
validationVehicleList = [5,6,11,24,29,42,83,92,60,109,120,36,11,25,52,6,25,38,50,13,68,112]
            ...
            for anotationIndex, object in enumerate(self.annotations):
                ...
                for trajIndex in range(3,TargetVehiclePoseLength):
                    ...
                    for distIndex,eachSurroundingPose in enumerate(currentSurroudingPoseList):
                        ...
                        surroudingDist = math.sqrt(((currentSurroundingX-currentSurroundingY)**2) + ((currentSurroundingY-targetPoseY)**2)) # this is wrong...
        ...
        for idx in range(historyTemporal,currentVehicleLength-futureTemporal):
            ...
            for jdx in range(idx-historyTemporal,idx):
                ...
                if(jdx > 0):
                    ...
                    resultMapImage = cv2.putText(resultMapImage, str(targetVehicleID), (prevPoseX,prevPoseY), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,255), 2, cv2.LINE_AA)
                    resultRadarImage = cv2.putText(resultRadarImage, str(targetVehicleID), (prevPoseX,prevPoseY), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,255), 2, cv2.LINE_AA)
...
def __main__():
    ...
    if(trainOrTest == trainStr):
        ...
        # Save the model
        encoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV15.h5')
        decoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV15.h5')


    elif(trainOrTest == testStr):
        print('Starting testing !!!')

        encoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/NavtechCollectModels/encoderV15Collect.h5')
        decoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/NavtechCollectModels/decoderV15Collect.h5')
