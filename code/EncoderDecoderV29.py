...
# Path for Sen server folder
encoderModelFilename = '/media/disk1/sap/Junction/V29Encoder15.h5'
decoderModelFilename = '/media/disk1/sap/Junction/V29Decoder15.h5'
# Path for Big Screen Server folder
...
resultFileName = 'EncoderV29Run41.txt'
...
def GetCallBacks():
    ...
    class EarlyStoppingByLossVal(callbacks.Callback):
        def __init__(self, monitor='val_loss', value=0.75, verbose=0):
