...
# Diffent Maneuver and velocity fix and batchNorm and removed angle
...
inputFeature = 9
inputFeatureWithoutID = inputFeature-2    # (2 -> withoutID and without angle)
    ...
    for eachTrainCar in carInfoList:
        ...
        for idx in range(historyTemporal,currentVehicleLength-futureTemporal):
            ...
            for jdx in range(idx-historyTemporal,idx):
                ...
                currentFrameInput = [normCurrentPoseX,normCurrentPoseY,normCurrentVx,normCurrentVy,normCurrentLaneDist,normCurrentLaneNumber,normCurrentMovement]
                ...
                for indexRange in range(0,len(surroudingInfo),inputFeature):
                    ...
                    currentSurroundingInfo = [normSurroudingPoseX,normSurroudingPoseY,normSurroudingVx,normSurroudingVy,normSurroudingLaneDist,normSurroudingLaneNumber,normSurroudingMovement]
...
class EarlyStoppingByLossVal(callbacks.Callback):
    def __init__(self, monitor='val_loss', value=5.0, verbose=0):
    ...
    for eachTrainCar in carInfoList:
        ...
        for idx in range(historyTemporal,currentVehicleLength-futureTemporal,int(historyTemporal/2)):
            ...
            for jdx in range(idx-historyTemporal,idx):
                ...
                tempInput = [normCurrentPoseX,normCurrentPoseY,normCurrentVx,normCurrentVy,normCurrentLaneDist,normCurrentLaneNumber,normCurrentMovement]
...
def __main__():
    ...
    if(trainOrTest == trainStr):
        ...
        # Save the model
        encoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV12b.h5')
        decoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV12b.h5')


    elif(trainOrTest == testStr):
        print('Starting testing !!!')

        encoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV12b.h5')
        decoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV12b.h5')
