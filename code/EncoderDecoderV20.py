# leaky 0.5 early 0.18 but new uncheck data epochs_drop = 6.0 (from 2.0) batch 128 ( -> 256 (6.69 error)) 
# Check the K.set_leraning_phase test... no batchNorm
# Last time converged and result -> 11.5
# old data, New arch, early 0.17, batch 256, all BatchNorms, epochs_drop = 10.0 -- running

# Big Screen server 1st terminal
import os
...
folderName = '/home/sap/Sap/Junction/Surrounding4RelativeDecoderJuncDist'             #         EligibilityCheckRemovedD1
...
resultFileName = 'V20ModidiedDecoder17.txt'
...
class EarlyStoppingByLossVal(callbacks.Callback):
    def __init__(self, monitor='val_loss', value=0.17, verbose=0):
