...
# old data, early 0.25, batch 1024, No batchnorm, epochs_drop = 6.0 , ELU, Nadam --> early 0.18 and 0.22 error is 4.87
# old data, early 0.20, batch 256, No batchnorm, epochs_drop = 6.0 , ELU, Nadam -- 5.8
# old data, early 0.25, batch 256, No batchnorm, epochs_drop = 6.0 , ELU, Nadam -- around 7, 
# old data, early 0.18, batch 256, No batchnorm, epochs_drop = 6.0 , ELU, Nadam -- error 16.2, 
# old data, early 0.17, batch 1024, No batchnorm, epochs_drop = 6.0 , ELU, Nadam -- error 5.00, 
# new data, early 0.20, batch 1024, No batchnorm, epochs_drop = 10.0 , ELU, Nadam, Confusion -- running
...
resultFileName = 'V26ModidiedDecoder32.txt'
...
def ValidationSetPredict(encoder_model,decoder_model,XVal,decoderValInput,YPoseVal,YClassVal,maxRealtiveX,maxRealtiveY):
    ...
    # Initialize the list for true and predicted class str
    classStrList = []
    ...
    for pdx,eachXVal in enumerate(XVal):
        ...
        groundtruthClass = YClassVal[pdx]
        ...
        for t in range(futureTemporal):
            ...
            trueClassFloat = (groundtruthClass[t].argmax())/2   # divide by 2 to convert 0,1,2  to 0,0.5,1.0
...
def step_decay(epoch):
    initial_lrate = 0.001  # 0.001 for Adma and RMSProp , 0.002 for Nadam 
    drop = 0.5
    epochs_drop = 10.0
...
class EarlyStoppingByLossVal(callbacks.Callback):
    def __init__(self, monitor='val_loss', value=0.20, verbose=0):
...
if __name__ == '__main__':
    ...
    ValidationSetPredict(encoder_model, decoder_model, XVal, decoderValInput, YPoseVal, YClassVal, maxRealtiveX, maxRealtiveY)
