...
validationVehicleList = [126,139,110,119,64,66,70,83,98,67,6,8,20,22,31,33,47,54]
    ...
    for eachTrainCar in carInfoList:
        ...
        for idx in range(historyTemporal,currentVehicleLength-futureTemporal):
            ...
            for jdx in range(idx-historyTemporal,idx):
                ...
                resultMapImage = cv2.putText(resultMapImage, 'Red : Input Trajectory', (750,140), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2, cv2.LINE_AA)
                ...
                resultRadarImage = cv2.putText(resultRadarImage, 'Red : Input Trajectory', (750,140), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2, cv2.LINE_AA)
                ...
                if(jdx > 0):
                    ...
                    if(currentMovement == 0):
                        angleColor = (238,130,238)
                    resultRadarImage = cv2.line(resultRadarImage, (prevPoseX, prevPoseY), (currentPoseX, currentPoseY), (0,0,255), lineThickness)
                    resultMapImage = cv2.line(resultMapImage, (prevPoseX, prevPoseY), (currentPoseX, currentPoseY), (0,0,255), lineThickness)
...
def __main__():
    ...
    if(trainOrTest == trainStr):
        ...
        # Save the model
        encoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/AlvieEncoderV1.h5')
        decoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/AlvieDecoderV1.h5')


    elif(trainOrTest == testStr):
        print('Starting testing !!!')

        encoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/AlvieEncoderV1.h5')
        decoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/AlvieDecoderV1.h5')
