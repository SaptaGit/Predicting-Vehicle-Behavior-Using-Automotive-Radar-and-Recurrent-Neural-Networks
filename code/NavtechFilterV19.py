###############################################################################################################
# This one is training and testing on the Sighthill data with perfect detection and no frame drop for simualated
# mis-detection. The combined mis detection and Particle Filter based trajectory generation is done in the next
# version, V20. 
###############################################################################################################
...
trainStr = 'Train'
testStr = 'Test'
trainOrTest = testStr   #   do not change ....collect data first....
...
def TestModel(encoder_model,decoder_model):
    ...
    for eachTrainCar in carInfoList:
        ...
        for idx in range(historyTemporal,currentVehicleLength-futureTemporal,5):
