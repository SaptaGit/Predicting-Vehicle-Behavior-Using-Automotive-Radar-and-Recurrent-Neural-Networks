...
def CreateModel():    
    ...
    model.compile(optimizer=opt, loss=['categorical_crossentropy', logcosh, logcosh])
    model.summary()
...
def __main__():
    ...
    if(trainOrTest == trainStr):
        ...
        # Save the model
        encoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoder.h5')
        decoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoder.h5')
