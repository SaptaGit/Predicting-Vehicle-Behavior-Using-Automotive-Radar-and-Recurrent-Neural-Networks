...
if __name__ == '__main__':
    ...
    velocityNormalized1 = Lambda(lambda x: x-minVelConst)
    velocityConcat = velocityNormalized1(velocityOut)
    velocityNormalized2 = Lambda(lambda x: x/minMaxVelDiffConst)
    velocityConcat = velocityNormalized2(velocityConcat)
    ...
    model.fit([XTrain,decoderTrainInput], [YClassTrain,YVelTrain,YPoseTrain], batch_size=128, epochs=30, verbose=1, validation_data=([XVal,decoderValInput],[YClassVal,YVelVal,YPoseVal]))
