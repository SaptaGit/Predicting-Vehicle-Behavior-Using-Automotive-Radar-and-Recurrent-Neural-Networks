...
# Maneuver and velocity fix and dropout
...
def CreateModel():
    ...
    encoder1 = LSTM(n_units, return_state=True, return_sequences=True, recurrent_dropout=dropOutFrac)
    encoder_output, state_h1, state_c1 = encoder1(encoder_inputs)
    encoder_states1 = [state_h1, state_c1]
    # Second Encoder LSTM Layer
    encoder2 = LSTM(n_units, return_state=True, recurrent_dropout=dropOutFrac)
    ...
    decoder_lstm1 = LSTM(n_units, return_sequences=True, return_state=True, recurrent_dropout=dropOutFrac)
    ...
    decoder_output1 = dropOut1(decoder_output1)
    dropOut2 = Dropout(dropOutFrac)
    ...
    decoder_output1 = dropOut2(decoder_output1)
    # dropOut7 = Dropout(dropOutFrac)
    ...
    # decoder_output1 = dropOut7(decoder_output1)
    # dropOut10 = Dropout(dropOutFrac)
    ...
    # decoder_output1 = dropOut10(decoder_output1)
    ...
    decoder_output2 = dropOut3(decoder_output2)
    dropOut4 = Dropout(dropOutFrac)
    ...
    decoder_output2 = dropOut4(decoder_output2)
    # dropOut8 = Dropout(dropOutFrac)
    ...
    # decoder_output2 = dropOut8(decoder_output2)
    ...
    # decoder_output2 = dropOut11(decoder_output2)
    ...
    decoder_output3 = dropOut5(decoder_output3)
    dropOut6 = Dropout(dropOutFrac)
    ...
    decoder_output3 = dropOut6(decoder_output3)
    # dropOut9 = Dropout(dropOutFrac)
    ...
    # decoder_output3 = dropOut9(decoder_output3)
    ...
    # decoder_output3 = dropOut12(decoder_output3)
...
def __main__():
    ...
    if(trainOrTest == trainStr):
        ...
        # Save the model
        encoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV9.h5')
        decoder_model.save_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV9.h5')


    elif(trainOrTest == testStr):
        print('Starting testing !!!')

        encoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/encoderV9.h5')
        decoder_model.load_weights('/home/saptarshi/PythonCode/Junction/NavtechModels/decoderV9.h5')
