...
radarImagePath = '/home/saptarshi/PythonCode/Junction/SightHillSample/SighthillJunc_3/Navtech_Cartesian/000001.png'
...
saveImageFilePath = '/home/saptarshi/PythonCode/Junction/CaseStudy/SightHillCount.png'
...
class Sequence:
    ...
    def playByVehicle(self,sequence_path,idOffset):
        ...
        global globalRadarImage,globalMapImage,highestFrameCount,globalLeftTurn,globallRightTrun,globalStraight,avgTrajLen
        ...
        if (self.annotations != None):
            for object in self.annotations:
                ...
                avgTrajLen.append(smoothTrajLength)
                maneuverList = []
...
def __main__():
    ...
    globalMapImage = cv2.putText(globalMapImage, 'Left Cars:' + str(globalLeftTurn), (700,95), cv2.FONT_HERSHEY_SIMPLEX, 1.3, (0,0,255), 2, cv2.LINE_AA)
    ...
    globalRadarImage = cv2.putText(globalRadarImage, 'Left Cars:' + str(globalLeftTurn), (700,95), cv2.FONT_HERSHEY_SIMPLEX, 1.3, (0,0,255), 2, cv2.LINE_AA)
    ...
    print('Average Traj Length : ' + str(mean(avgTrajLen)))
    print('Minimum Traj Length : ' + str(min(avgTrajLen)))
    print('Max Traj Length : ' + str(max(avgTrajLen)))
